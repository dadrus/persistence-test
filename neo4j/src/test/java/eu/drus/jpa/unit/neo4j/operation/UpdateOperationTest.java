...
public class UpdateOperationTest {
    ...
    public void testExecute() throws Exception {
        ...
        assertThat(queries.get(1), containsString("MATCH (n2:A {id:2}) SET n2.value=\"B\""));
        assertThat(queries.get(2), containsString("MATCH (n1:A {id:1}),(n2:A {id:2}) MATCH (n1)-[e1:E]->(n2) SET e1.id=3,e1.value=\"C\""));
    }
}
